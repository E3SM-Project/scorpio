...
int PIOc_rename_att(int ncid, int varid, const char *name, const char *newname)
{
  ...
  SPIO_Util::GPTL_Util::GPTL_timer func_timer("SPIO:PIOc_rename_att");
#endif
...
{
#if SPIO_ENABLE_API_TIMING
  SPIO_Util::GPTL_Util::GPTL_timer func_timer("SPIO:PIOc_del_att");
#endif
#if SPIO_ENABLE_API_TRACING
...
{
#if SPIO_ENABLE_API_TIMING
  SPIO_Util::GPTL_Util::GPTL_timer func_timer("SPIO:PIOc_inq_attx");
#endif
  int ret = PIO_NOERR;
#if SPIO_ENABLE_API_TRACING
...
{
#if SPIO_ENABLE_API_TIMING
  SPIO_Util::GPTL_Util::GPTL_timer func_timer("SPIO:PIOc_copy_att");
#endif
#if SPIO_ENABLE_API_TRACING
